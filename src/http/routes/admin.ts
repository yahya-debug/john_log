...
import type { ValidatedLog } from "../../types/log.js";
...
router.get('/dead-letter', async function (req: Request, res: Response) {
...
router.post('/dead-letter/replay', async function (req: Request, res: Response) {
...
router.get('/logs/tail', function (req: Request, res: Response) {
    ...
    function onFlushed(entries: ValidatedLog[]) {
